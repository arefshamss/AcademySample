...
import {persianTranslation} from './translations/fa.js';

const editorConfig = {
    language: "fa",
    translations: persianTranslation,
    toolbar: {
        items: [
            'undo',
            'redo',
...
function initializeCkEditor(selector = null) {
    if (selector === null) {
        ...
        const editors = document.querySelectorAll(`${selector} textarea[ckeditor]`);
