...
[HtmlTargetElement("prep-messages")]
public class PreparedMessagesTagHelper : TagHelper
{
    ...
    public override void Process(TagHelperContext context, TagHelperOutput output)
    {
        ...
        var htmlContent =
            $"<label class=\"form-label\">پیام های آماده</label>\n<select class=\"form-control\" id=\"modal-prepared-message\" data-select2-url=\"/Admin/prepared-messages-select?Section={Section}\" onchange=\"onPreparedMessageSelect('{Property.Name}')\"></select>";
