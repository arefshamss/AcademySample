...
public class PdfFileResult(byte[] fileContents) : IActionResult
{
    ...
    public Task ExecuteResultAsync(ActionContext context)
    {
        ...
        _fileName = FileGeneratorStatics.PdfFileName;
        var response = context.HttpContext.Response;
        response.Headers.Add("Content-Disposition", $"attachment; filename=\"{_fileName}\"");
        response.ContentType = FileGeneratorStatics.PdfContentType;
